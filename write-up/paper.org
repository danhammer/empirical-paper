...
the global transportation sector.  Any viable effort to mitigate
climate change must address deforestation.  This is a difficult
proposition, however, since most deforestation occurs in tropical
countries, which rely heavily on cleared land as an input for
agriculture.  Indonesia, for example, is responsible for roughly 20%
of annual deforestation, worldwide [FAO]; but the agricultural sector,
broadly defined, contributed almost 10% of gross domestic product
in 2007.  The rural economy relies heavily on products derived from
cleared land. There exist incentives at every level to convert
standing forest to fiscally productive land.  As part of a grand
Coasian bargain, Norway pledged US$1 billion in aid to Indonesia,
...
This paper evaluates the effectiveness of the moratorium in reducing
the deforestation rate in Indonesia.  Midway through the moratorium,
the impact of the conservation policy is hotly contested.  The
Indonesia goverment claims a resounding success, with the Minister of
Forestry asserting that "the moratorium ... has proven to effectively
reduce forest destruction" and that the forest clearing rate has
declined by at least one-third since the enactment of the moratorium.
Various environmental groups, however, insist that the moratorium has
had no effect on aggregate clearing activity; and in fact Greenpeace
claims that deforestation has actually increased since the moratorium.
Greenpeace contends that illegal clearing activity and poorly defined
moratorium maps are at the root of the increased clearing rate.  The
Jakarta Globe reported in May 2012 that over 10% of existing forests
in Kalimantan, Indonesia were cleared in the previous year.  Satellite
imagery supports the claim of accelerating deforestation in Indonesia,
despite the moratorium. This paper tests the hypothesis that the
deforestation rate increased /because/ of the moratorium --- at least
in the short-run.\\

The theoretical support for this paper is a direct extension of the
optimal control framework designed by Weitzman (1976, 1980, 2003).


claims that the combination of poorly defined areas under
the moratorium, estimates that Satellite imagery supports the claim of
increased deforestation since the moratorium was enacted, but there is
still argument about which forests are within the moratorium's
geographic extent.
...
optimization of $G(\cdot)$, or optimal control of $\I$, will determine
the time-path of the firm's capital development.  This detailed
information is incidental, however, for our relatively simple
application to identify the impact of the moratorium on the aggregate
rate of capital investment.  For this type of application, Weitzman
suggests an "old economist's trick" to collapse the dynamic problem to
its stationary equivalent.\\
